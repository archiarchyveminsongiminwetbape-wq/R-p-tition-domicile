...
export default function Revenus({ seances }) {
  ...
  const total2026 = MOIS_DATA.reduce((a, m) => a + m.val, 0)
  const max = Math.max(...MOIS_DATA.map(m => m.val))
  ...
  return (
    <div className="fade-in">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16, marginBottom: 28 }}>
        {[
          { icon: "💰", label: "Revenus ce mois",       val: "49 500 FCFA",                              bg: "#EFF6FF", accent: "#1A56DB" },
