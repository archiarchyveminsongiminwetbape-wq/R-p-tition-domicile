...
// Middleware
app.use(cors({
  origin: ['http://localhost:5173', 'http://localhost:3000', 'http://127.0.0.1:5173', 'http://127.0.0.1:3000', 'https://r-p-tition-domicile.vercel.app', 'https://discard-bungee-handiwork.ngrok-free.dev'],
  credentials: true
}));
